...
func TestImageWithMetadata(t *testing.T) {
	tests := map[string]struct {
		...
		expectedImage imageapiv1.Image
		expectError   bool
	}{
		"no manifest data": {
			image:         imageapiv1.Image{},
			...
			expectedImage: imageapiv1.Image{
				ObjectMeta: metav1.ObjectMeta{
					...
					Annotations: map[string]string{
						imageapiv1.DockerImageLayersOrderAnnotation: imageapiv1.DockerImageLayersOrderAscending,
					},
				},
				...
				DockerImageMetadata: imageapiv1.DockerImage{
					...
					ContainerConfig: imageapiv1.DockerConfig{
					...
					DockerVersion: "1.4.1",
					Author:        "",
					Config: &imageapiv1.DockerConfig{
						Hostname:        "43bd710ec89a",
						Domainname:      "",
						User:            "",
						Memory:          0,
...
func validImageWithManifestData() imageapiv1.Image {
...
func validImageWithManifestV2Data() imageapiv1.Image {
	return imageapiv1.Image{
		ObjectMeta: metav1.ObjectMeta{
			Name: "id",
		},
