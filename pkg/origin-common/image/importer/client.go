...
func schema1ToImage(manifest *schema1.SignedManifest, d godigest.Digest) (*imageapiv1.Image, error) {
...
func schema2ToImage(manifest *schema2.DeserializedManifest, imageConfig []byte, d godigest.Digest) (*imageapiv1.Image, error) {
	mediatype, payload, err := manifest.Payload()
	if err != nil {
		return nil, err
	}
...
func schema0ToImage(dockerImage *dockerregistry.Image) (*imageapiv1.Image, error) {
	var baseImage imageapiv1.DockerImage
...
func unmarshalDockerImage(body []byte) (*imageapiv1.DockerImage, error) {
	var image dockerpre012.DockerImage
	if err := json.Unmarshal(body, &image); err != nil {
		return nil, err
	}
	dockerImage := &imageapiv1.DockerImage{}
